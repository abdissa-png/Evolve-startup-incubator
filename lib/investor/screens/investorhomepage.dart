...
import '../models/investorhomepagemodel.dart';
export '../models/investorhomepagemodel.dart';
...
class _InvestorhomepageWidgetState extends State<InvestorhomepageWidget> {
  late InvestorhomepageModel _model;
  ...
  // void initState() {
  //   super.initState();
  //   _model = createModel(context, () => InvestorhomepageModel());
  // }
